    ...
    <div className="card shadow-md mb-3 mt-3">
      <div className="card-body text-right row align-items-center">
        <div className="col-md-7">
          <div className="justify-content-even align-items-center row">
            <div className="col-md-5">
              <span className="card-title font-weight-bold align-self-left mr-5">
        ...
        <div className="col-md-5 text-right">
          ...
          >
            {" "}
            Create Activity <i className="fas fa-plus"></i>
          </button>
        </div>
      </div>
    </div>
            ...
            <div className="card-body">
              ...
              <div className="text-right">
                <button
                  ...
                  onClick={() => handleUpdateRoute(a._id)}
    ...
    <div className="card shadow-md mb-3 mt-3">
      <div className="card-body text-right row align-items-center">
        <div className=" text-left col-md-5">
          <span className="card-title font-weight-bold ml-3">
            <i
              style={{ fontSize: "18px" }}
              className="fas fa-bookmark mx-1"
            ></i>
      ...
      <div className="Admin">
        <div class="main-act mb-5 card shadow-md">
          <div
            ...
            class="card-header px-5 pt-4"
          >
            <ul class="nav nav-tabs card-header-tabs">
              <li
                onClick={() => this.handleTabs("activity")}
                id="activity"
                class="nav-item"
              >
                <span
                  class={` pb-2 nav-link ${
                    this.state.tab === "activity" ? "active" : ""
                  }`}
                >
                  Activities
                </span>
              ...
              <li
                onClick={() => this.handleTabs("student")}
                id="student"
                class="nav-item"
              >
                <span
                  class={` pb-2 nav-link ${
                    this.state.tab === "student" ? "active" : ""
                  }`}
                >
                  Students
                </span>
              ...
              <li
                onClick={() => this.handleTabs("bookmark")}
                id="bookmark"
                class="nav-item"
              >
                <span
                  class={` pb-2 nav-link ${
                    this.state.tab === "bookmark" ? "active" : ""
                  }`}
                >
                  Bookmarked Activities
                </span>
          ...
          <div class="card-body">
            {this.state.tab === "activity" ? (
              ...
              <Bookmark
                ...
                handleUpdateRoute={this.handleUpdateRoute}
                handleCreateRoute={this.handleCreateRoute}
                all_activities={this.state.all_activities.filter(
                  (a) => a.bookmarked
                )}
              />
            ) : (

...
class UpdateActivity extends Component {
  ...
  handleCheck = (e) => {
    if (e.target.checked) {
      ...
      let arr = [
        ...this.state.students.slice(0, idx),
        ...this.state.students.slice(idx + 1, this.state.students.length),
      ];
      ...
      if (flag !== -1) {
        completed_arr = [
          ...this.state.completed.slice(0, flag),
          ...this.state.completed.slice(flag + 1, this.state.completed.length),
        ];
      }
  ...
  handleCompleted = (e) => {
    ...
    if (e.target.checked) {
      ...
      let arr = [
        ...this.state.completed.slice(0, idx),
        ...this.state.completed.slice(idx + 1, this.state.completed.length),
      ];
                  ...
                  {this.state.student_list.map((s, idx) => (
                    <tr key={s._id}>
                      ...
                      <td>
                        <div class="custom-control custom-checkbox">
                          <input
                            checked={this.checkCompeleted(s._id)}

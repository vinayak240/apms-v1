          ...
          <>
            ...
            <div className="content row justify-content-around">
              ...
              <div
                ...
                className="profile-info card col-md-3 text-center"
              >
                <span className="profile-pic card-img-top">
                  {this.state.user.name.split(" ")[0][0] + "" ||
                    this.state.user.name.split(" ")[1][0]}
                </span>
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">
                    <ul className="list-group list-group-flush">
                      ...
                      <li className="list-group-item">
                        {this.state.user.sem} - {this.state.user.dept}{" "}
                      </li>
                    </ul>
                  </li>
              ...
              <div
                ...
                className="activity-info col-md-8 card"
              >
                <div className="points-info">
                  ...
                  <div class=" points card shadow-none mb-1">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">
                        {this.state.user.activities.length}
                      </h5>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="col-md-7">
                          <div class="card-body">
                            <h5 class="card-title">
                              ...
                              >
                                {new Set(this.state.user.completed).has(a._id)
                                  ? "Completed"
                                  : "Not completed"}
                              </span>
                            </h5>

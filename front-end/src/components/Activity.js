...
class Activity extends Component {
  ...
  bookmark = async () => {
    let response = await Axios.post(
      `${API_URL["all_activities"]}/${this.state.id}/bookmark/`
    );
  ...
  render() {
    const img = [
      require("../img/cabin.png"),
      require("../img/cake.png"),
      require("../img/circus.png"),
    ];
    return (
          ...
          <>
            ...
            <div>
              <div
                ...
                className="row justify-content-around m-3"
              >
                      ...
                      <div className="row p-0 justify-content-stretch align-items-center">
                        <div className="col-md-9">
                          <h5>
                            ...
                            <span>{this.state.bookmarked ? "YES" : "NO"}</span>{" "}
                          </h5>
                        </div>
                        <div className="col-sm-3 text-right">
                          {this.props.location.state &&
                          this.props.location.state.from &&
                          this.props.location.state.from === "/admin" ? (
                            <button
                            ...
                            >
                              {this.state.bookmarked ? "Marked" : "Mark"}{" "}
                              <i
                                className={`${
                                  this.state.bookmarked ? "fas" : "far"
                                } fa-bookmark`}
                              ></i>
                            </button>
                          ) : (
              ...
              >
                ...
                <div className="card-body p-4 text-center">
                  <div className="card-text text-center">{this.state.desc}</div>
                </div>
              </div>
              <div
                style={{
                ...
                className="student-list text-center card shadow-sm  mt-5"
              >
                ...
                <div className="card-body">
                  {!this.state.isList ? (
                    <div className="text-center mt-3">
                      <button
                        onClick={this.getInvolvedStudents}
                        style={{
                      ...
                      <tbody>
                        {this.state.student_list.map((s, idx) => (
                          <tr key={s._id}>
                            ...
                            <td>Involved</td>
                            <td>
                              {new Set(this.state.completed).has(s._id)
                                ? "Completed"
                                : "Not completed"}
                            </td>
                          </tr>
